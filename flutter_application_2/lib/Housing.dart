              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.bookmark, color: const Color.fromRGBO(255, 204, 51, 1.0)),
                  ],
                ),
                SizedBox(height: 10),
                ...
                Text(
                  location,
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color:const Color.fromRGBO(255, 204, 51, 1.0)),
                ),
                SizedBox(height: 5),
                Text(
                  details,
                  style: TextStyle(fontSize: 16, color:const Color.fromRGBO(255, 204, 51, 1.0)),
                ),
                 SizedBox(height: 5),
                Text(
                  price,
